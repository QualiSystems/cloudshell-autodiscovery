...
class TestEchoUserInputTemplateCommand(unittest.TestCase):
    ...
    def test_execute_in_json_format(self, utils, open_, yaml, json, click):
    ...
    @mock.patch("autodiscovery.commands.echo_user_input_template.open")
    @mock.patch("autodiscovery.commands.echo_user_input_template.utils")
    def test_execute_in_yaml_format(self, utils, open_, click):
    ...
    def test_execute_save_to_file(self, utils, open_, click):
        ...
        # verify
        open_.assert_any_call(example_filename)
        open_.assert_any_call(save_to_filename, "w")
